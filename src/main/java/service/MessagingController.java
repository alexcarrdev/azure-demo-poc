...
public class MessagingController {
    ...
    public ServiceResponse exampleGet() {
        ...
        LOGGER.info("Received GET request to /exampleGet. This is the original commit!");

        ServiceResponse response = new ServiceResponse();

        response.setUuid(1L);
        response.setAdditionalStatusCode("200");
        response.setAdditionalStatusMsg("Successful hit to the /exampleGet endpoint. This is from the old commit.");
